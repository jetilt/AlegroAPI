...
class TestPetStoreAPIRequests:
    ...
    def test_create_pet_invalid_input(self, api_session: requests.Session):
        """
    ...
    def test_get_pet_not_found(self, api_session: requests.Session):
        """
        This negative test tries to retrieve a non-existent pet
        Endpoint: GET https://petstore.swagger.io/v2/pet/{petId}
        """
        fake_id = 45612378901234
        response = api_session.get(f"{BASE_URL}/pet/{fake_id}")
    ...
    def test_get_pet_invalid_id(self, api_session: requests.Session):
        """
    ...
    def test_update_pet_invalid_id(self, api_session: requests.Session):
        """
    ...
    @pytest.mark.xfail(
        reason="FAIL: API returns 200 instead of 404 for non-existent pet on PUT")
    def test_update_pet_not_found(self, api_session: requests.Session):
        """
    ...
    def test_update_pet_validation_exception(self, api_session: requests.Session):
        """ 
    ...
    def test_find_pet_by_invalid_status(self, api_session: requests.Session):
        """
    ...
    def test_delete_pet_invalid_id(self, api_session: requests.Session):
        """
    ...
    def test_delete_pet_not_found(self, api_session: requests.Session):
        """ 
        ...
        response = api_session.delete(f"{BASE_URL}/pet/{fake_id}")
